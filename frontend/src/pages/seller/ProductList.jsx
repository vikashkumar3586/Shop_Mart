    ...
    return (
        <div className="flex-1 py-10 flex flex-col justify-between">
            <div className="w-full md:p-10 p-4">
                ...
                {products.length > 0 && products.every(product => !product.inStock) && (
                    <div className="text-center py-8 bg-yellow-50 border border-yellow-200 rounded-md">
                        <p className="text-yellow-600">All products are currently out of stock</p>
                        <p className="text-yellow-500 text-sm">Enable stock for your products to start selling</p>
                    </div>
                )}
